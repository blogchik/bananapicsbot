...
TRANSLATIONS: dict[str, str] = {
    ...
    "profile_id_label": "👤 Sizning ID",
    "profile_balance": "💰 Balans: <b>{balance}</b> credit",
    "profile_generations_estimate": "🧮 Taxminiy generatsiya: <b>{count}</b> ta",
    ...
    # Referral
    "referral_description": "Do'stlaringizni taklif qiling va bonus oling:\n• Qo'shilganda darhol <b>20 credit</b>\n• To'lovlaridan <b>{percent}%</b> bonus\n\nReferral faqat yangi userlar uchun ishlaydi.",
    "referral_bonus_total": "Yig'ilgan bonus: <b>{total} credit</b>",
