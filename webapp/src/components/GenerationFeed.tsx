...
export const GenerationFeed = memo(function GenerationFeed() {
  ...
  if (isLoading) {
    return (
      <div ref={scrollContainerRef} className="h-full overflow-y-auto pt-28 pb-24">
  ...
  if (generations.length === 0) {
    return (
      <div className="h-full flex items-center justify-center pt-28 pb-24">
        <EmptyState />
      </div>
    );
  }
  ...
  return (
    <div ref={scrollContainerRef} className="h-full overflow-y-auto pt-28 pb-24 scroll-smooth">
